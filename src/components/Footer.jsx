...
function Footer() {
  ...
  return (
    <section id="footer-section">
      <div className="flex flex-col font-dmsans space-x-10 md:space-x-24 md:flex-row md:p-24">
        <div className="flex flex-col mx-10 py-16 md:pb-16 md:pt-0 md:mx-auto">
          <div className="flex flex-row place-items-center pb-5 space-x-3 md:pb-10">
            ...
            <a href="">
              <img className="w-28" src={flutterwave} alt="" />
            </a>
          </div>
          <p className="text-white text-lg">NotPayDay © {year}</p>
        </div>
        ...
        <div className="flex flex-col space-y-4 text-white text-lg pb-16">
        ...
        <div className="text-white space-y-4 text-lg pb-16">
