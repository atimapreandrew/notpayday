...
const ProAccounts = () => {
  return (
    <section id="proaccts-section">
      <div className="flex bg-veryDarkBlue mx-4 px-8 mb-7 pt-7 font-opensans rounded-3xl md:px-32 md:mx-32">
        <div className="flex flex-col md:flex-row">
          <div className="flex flex-col my-auto text-white">
            <h3 className="text-lg font-bold pb-3 md:pb-7 md:text-xl">
              Pro accounts
            </h3>
            <h2 className="text-4xl font-bold md:text-5xl">Create</h2>
            <h2 className="text-4xl font-bold pb-3 md:pb-7 md:text-5xl">
